...
![Version: 17.3.3](https://img.shields.io/badge/Version-17.3.3-informational?style=flat-square) ![AppVersion: 1.26.1](https://img.shields.io/badge/AppVersion-1.26.1-informational?style=flat-square)
...
| image.tag | string | `"1.26.1-debian-12-r0"` |  |
...
| metrics.image.tag | string | `"1.2.0-debian-12-r0"` |  |
